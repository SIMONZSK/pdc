...
public class FrameLogin extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        if ("User".equals(selectedItem)) {
            ...
            userDB.closeBaseDB();
            if (result) {
                JOptionPane.showMessageDialog(this, "Welcome ¡¾" + selectedItem + "¡¿£º" + userName + " Login in Hotel-Booking-System£¡");
                this.dispose();
            ...
            UserController userDB = new UserController();//»ñÈ¡²éÑ¯µ½µÄÊµÀý
            UserInfo userInfoTmp = new UserInfo();
            userInfoTmp.setUserName(userName);
            userInfoTmp.setPassword(password);
            userInfoTmp.setUserType(false);
